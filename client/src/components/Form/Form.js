...
const Form = ({ currentId, setCurrentId }) => {
    ...
    const post = useSelector((state) => currentId ? state.posts.find((p) => p._id === currentId): null);  // We want to fetch updated post from state.posts(store} if currentId is not null that is what we are doing
